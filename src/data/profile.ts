...
export const doctor = {
  ...
  bookingUrl: 'https://booking.avaclinic.ru/spb',
...
export const helpItems = [
  ...
  'Повышенное давление',
  'Оценка ЭКГ, Холтера и ЭхоКГ',
  'Профилактический кардиологический осмотр',
  'С жалобами на одышку и отеки',
  'Со снижением толерантности к привычным физическим нагрузкам',
  'С любыми формами нарушения обмена холестерина',
  'Ведение пациентов кардиологического профиля после хирургических вмешательств на сердце и сосудах',
];
