...
export const doctor = {
  ...
  // Личная ссылка MAX (аватар → QR-код → «Поделиться»); предзаполненный текст не поддерживается.
  maxUrl: 'https://max.ru/u/f9LHodD0cOI5MLwn7kW6b6iJRDY8HfcUJ589r8BsRsElRJYVsnA8t9DakYk',
...
export const onlineConsult = {
  ...
  price: '5 000 ₽',
  description: 'Напишите в удобном мессенджере — текст обращения уже подставлен, останется отправить.',
};
